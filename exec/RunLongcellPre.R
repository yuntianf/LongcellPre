...
argparse = function(){
  ...
  if(!full_help){
    ...
    ##### tag extraction
    p$add_argument("--window", help=argparse.SUPPRESS, default = 10)
    p$add_argument("--step", help=argparse.SUPPRESS, default = 2)
    p$add_argument("--left_flank", help=argparse.SUPPRESS, default = 0)
    p$add_argument("--right_flank", help=argparse.SUPPRESS, default = 0)
    p$add_argument("--drop_adapter", help=argparse.SUPPRESS, default = FALSE)
    p$add_argument("--polyA_bin", help=argparse.SUPPRESS, default = 20)
    p$add_argument("--polyA_base_count", help=argparse.SUPPRESS, default = 15)

    # parameters for barcode match
    p$add_argument("--barcode_len", help=argparse.SUPPRESS, default = 16)
    p$add_argument("--batch", help=argparse.SUPPRESS, default = 100)
    p$add_argument("--top", help=argparse.SUPPRESS, default = 5)
    p$add_argument("--cos_thresh", help=argparse.SUPPRESS, default = 0.25)
    p$add_argument("--edit_thresh", help=argparse.SUPPRESS, default = 3)
    p$add_argument("--UMI_len", help=argparse.SUPPRESS, default = 10)
    p$add_argument("--UMI_flank", help=argparse.SUPPRESS, default = 1)
    p$add_argument("--mean_edit_thresh", help=argparse.SUPPRESS, default = 1.5)

    # parameters for reads extraction
    p$add_argument("--map_qual", help=argparse.SUPPRESS, default = 30)
    p$add_argument("--end_flank", help=argparse.SUPPRESS, default = 200)

    # parameters for rerun
    p$add_argument("--force_barcode_match", help=argparse.SUPPRESS, default = FALSE)
    p$add_argument("--force_map", help=argparse.SUPPRESS, default = FALSE)
    p$add_argument("--force_isoform_extract", help=argparse.SUPPRESS, default = FALSE)

    # parameters for reads filtering
    p$add_argument("--splice_site_thresh", help=argparse.SUPPRESS, default = 10)
    p$add_argument("--filter_only_intron", help=argparse.SUPPRESS, default = TRUE)

    # parameters for mapping reads to isoform
    p$add_argument("--mid_offset_thresh", help=argparse.SUPPRESS, default = 3)
    p$add_argument("--overlap_thresh", help=argparse.SUPPRESS, default = 0)
